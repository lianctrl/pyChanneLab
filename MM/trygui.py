...
class App:
    def __init__(self, master):
        ...
        self.add_circle_button = Button(master, text='Add Circle', command=self.add_circle)
        self.add_circle_button.pack(side=LEFT)

        self.add_arrow_button = Button(master, text='Add Arrow', command=self.add_arrow)
        self.add_arrow_button.pack(side=LEFT)

        self.clear_button = Button(master, text='Clear All', command=self.clear)
