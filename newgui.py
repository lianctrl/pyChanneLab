...
class MainApp(tk.Tk):
    def __init__(self):
        ...
        self.open_dataloader_button = tk.Button(self,
                                                text="Open Data Loader",
                                                command=self.open_dataloader)
        self.open_dataloader_button.pack()
    ...
    def open_dataloader(self):
        loader_window = tk.Toplevel(self)
        DataLoader(loader_window)
